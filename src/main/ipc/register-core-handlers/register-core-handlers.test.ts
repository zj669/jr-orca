...
vi.mock('../jr', () => ({
  registerJrHandlers: registerJrHandlersMock
}))
...
describe('registerCoreHandlers', () => {
  beforeEach(() => {
    ...
    registerJrHandlersMock.mockReset()
  ...
  it('passes the store through to handler registrars that need it', async () => {
    ...
    expect(registerJrHandlersMock).toHaveBeenCalled()
